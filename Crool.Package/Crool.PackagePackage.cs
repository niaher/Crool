namespace Microsoft.Crool_Package
{
    ...
    [Guid(GuidList.GuidCroolPackagePkgString)]
    public sealed class Crool_PackagePackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if (null != mcs)
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.GuidCroolPackageCmdSet, (int)PkgCmdIDList.CmdidCrool);
